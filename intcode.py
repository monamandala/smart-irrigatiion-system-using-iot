...
pnconfig.subscribe_key = "sub-c-c13f518a-1014-11e9-84ec-c69945a9583a"
pnconfig.publish_key = "pub-c-6c33cb70-f44c-486c-875b-6d11383e8f9a"
pnconfig.ssl = False
...
pubnub.subscribe().channels('smartiot').execute()
...
while True:
	if flag ==1:
		...
		humidity, temperature = Adafruit_DHT.read_retry(22,11)
		DHT_Read = ('Temp:0:0.1f* Humidity:1:0.1f%'.format(temperature, humidity))
		print(DHT_Read)
	
		dictionary = {"eon": {"Temperature": temperature, "Humidity": humidity}}
		pubnub.publish().channel('smartiot').message([DHT_Read]).pn_async(publish_callback)
